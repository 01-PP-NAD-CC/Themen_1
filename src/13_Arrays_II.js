...
// push() / pop()
// push --> Daten rein ... (+)
// let arr = [];  // ein leeres array angelegt

// output(arr);
// arr.push("Ich");   // wir wenden die funktion push an auf das array 
// output(arr);     //  die funktion push pushed elemente in das array
// arr.push("bin");  // 2. element
// output(arr);
// arr.push("Max");  // 3. element 
// output(arr);

// // pop() --> Daten raus ... (-)
// output(arr.pop());       // schmeißt daten aus dem array raus aber von hinten beginnend nach vorne 
// output(arr);
// output(arr.pop());
// output(arr);
// output(arr.pop());
